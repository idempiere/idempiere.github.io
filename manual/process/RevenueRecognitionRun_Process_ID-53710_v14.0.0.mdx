...
*28/10/2014 → 23/03/2026*

![Revenue Recognition Run](/img/manual/RevenueRecognitionRun-Process_iDempiere_v14.0.0.png)

**Description:** Generate revenue recognition journal

**Comment/Help:** Generate GL journal based on valid revenue recognition run entries

**Classname:** `org.idempiere.acct.process.RevenueRecognition`
