...
*13/09/2009 → 23/03/2026*

![Tenant Accounting Processor](/img/manual/TenantAccountingProcessor-Process_iDempiere_v14.0.0.png)
...
**Classname:** `org.idempiere.acct.process.ClientAcctProcessor`
