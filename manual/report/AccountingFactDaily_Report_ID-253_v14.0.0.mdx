---
title: 'Accounting Fact Daily'
sidebar_label: 'Accounting Fact Daily'
...
<span className="badge badge--primary">Report</span> <span className="badge badge--secondary">ID 253</span>

*09/01/2004 → 27/08/2005*

![Accounting Fact Daily](/img/manual/AccountingFactDaily-Report_iDempiere_v14.0.0.png)
