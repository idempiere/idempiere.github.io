...
![01 MoveTenant](pathname:///img/new-features/v12/01_MoveTenant.png)
...
![Copy Tenant   Process (iDempiere 1.0.0)](pathname:///img/new-features/v12/Copy_Tenant_-_Process_(iDempiere_1.0.0).png)
