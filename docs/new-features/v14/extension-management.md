...
* **Configuration:**
    1. Configure the **Extension Provider URL** using the `IDEMPIERE_EXTENSION_REPOSITORY` System Property to point to a compatible metadata repository. For local development/testing, you can use `file:///path/to/your/extension-repository/` instead of remote repository hosted at github.com.
...
![Extension Registry: External Extension](/img/docs/new-features/ExtensionRegistry_External_Extension.png)
