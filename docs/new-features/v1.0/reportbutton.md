...
![report1](pathname:///img/new-features/v1.0/report1.png)

![report2](pathname:///img/new-features/v1.0/report2.png)

Make a report in the window and the result of the report will show the same register that the filter in the window shows.

![report3](pathname:///img/new-features/v1.0/report3.png)
...
![report4](pathname:///img/new-features/v1.0/report4.png)
...
![report5](pathname:///img/new-features/v1.0/report5.png)

It allows to export directly without rendering the report

![report6](pathname:///img/new-features/v1.0/report6.png)
